...
activities.each do |activity|
  Activity.create(name: activity[:title], location: activity[:country], duration: activity[:days], category: activity[:activity], image_url: activity[:image_url], description: activity[:description])
end
